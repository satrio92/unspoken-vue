  ...
  <div id="footer" class="w-full xl:w-[1100px] pt-12 border-t-2 border-white flex justify-between items-center">
		...
		<div class="flex flex-col items-end gap-4">
			<div class="border-2 border-white text-white flex rounded-lg overflow-hidden">
				<router-link to="/" class="py-4 px-12 flex items-center relative" active-class="font-semibold text-[#050915] bg-dropsunrise" exact>
					<span>Home</span>
			...
			<div class="w-full flex justify-between items-center">
				...
				<div class="flex gap-4">
					<a href="https://www.instagram.com/kukuhsatrio_/" target="_blank" class="w-11 h-11 border-2 border-white rounded-lg flex items-center justify-center text-xl text-white hover:bg-dropsunrise hover:text-black">
						<i class="bi bi-instagram"></i>
					</a>
					<a href="https://www.behance.net/satriodesign" target="_blank" class="w-11 h-11 border-2 border-white rounded-lg flex items-center justify-center text-xl text-white hover:bg-dropsunrise  hover:text-black">
						<i class="bi bi-behance"></i>
					</a>
					<a href="https://github.com/satrio92" target="_blank" class="w-11 h-11 border-2 border-white rounded-lg flex items-center justify-center text-xl text-white hover:bg-dropsunrise hover:text-black">
